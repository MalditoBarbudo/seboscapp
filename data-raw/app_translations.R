...
app_translations <- tibble::tribble(
  ...
  'fixed_click_plot_modal_title', 'Info', 'Info', 'Info',
  'fixed_plot_plots_title', 'Parcel·la {click$id}', '{click$id} plot', 'Parcela {click$id}',
  'fixed_plot_plots_subtitle', 'comparada amb altres parcel·les', 'compared with other plots', 'comparada con otras parcelas',
  'fixed_drawed_poly_plot_title', 'Polìgon dibuxat', 'Custom polygon', 'Polígono dibujado',
  'fixed_drawed_poly_plot_subtitle', 'comparació de parcel·les contingudes', 'comparision of plots contained', 'comparación de parcelas contenidas',
  'fixed_plots_inside_plot_title', 'Parcel·les dins de {click$id}', 'Plots inside {click$id}', 'Parcelas dentro de {click$klabel}',
  'fixed_plots_inside_plot_subtitle', '', '', '',
  'fixed_poly_comparision_plot_title',
    '{click$id} vs altres {translate_app(input$fixed_scale, lang())}',
    '{click$id} vs other {translate_app(input$fixed_scale, lang())}',
    '{click$id} vs otras {translate_app(input$fixed_scale, lang())}',
  'fixed_poly_comparision_plot_subtitle', '', '', '',
