...
variable_thesaurus <- tibble::tribble(
  ...
  ~var_service_eng, ~var_service_spa, ~var_service_cat,
  # static table
  "plot_id", "static", "-",
  ...
  "Food provision", "Provisión de alimentos", "Provisió d'aliments",
  ...
  "Water provision", "Provisión de agua", "Provisió d'aigua",
  ...
  "Climate regulation", "Regulación climática", "Regulació climàtica",
  ...
  "Soil fertility", "Fertilidad del suelo", "Fertilitat del sòl",
  ...
  "Flood regulation", "Regulación de inundaciines", "Regulació de las avingudes",
  ...
  "Soil erosion mitigation", "Erosión del suelo mitigada", "Erosió del sòl mitigada",
  ...
  "Timber provision", "Aprovisionamiento de madera", "Aprovisament de fusta",
